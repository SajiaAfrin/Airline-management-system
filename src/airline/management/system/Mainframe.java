...
public class Mainframe extends JFrame{
	...
	NewLabel.setBounds(0, 0, 2000, 990); 
	add(NewLabel); 
        JLabel AirlineManagementSystem = new JLabel("BIMAN BANGLADESH AIRLINE WELCOMES YOU");
	AirlineManagementSystem.setForeground(Color.RED);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.PLAIN, 40));
	AirlineManagementSystem.setBounds(300, 300, 1000, 55);
	...
	JMenu Ticket = new JMenu("TICKET");
        Ticket.setForeground(Color.MAGENTA);
	menuBar.add(Ticket);
	...
	JMenu Misc = new JMenu("MISC");
        Misc.setForeground(Color.MAGENTA);
	menuBar.add(Misc);
